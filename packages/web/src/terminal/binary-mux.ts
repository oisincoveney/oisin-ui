...
export const BinaryMuxChannel = {
  Terminal: 1,
  FileTransfer: 2,
} as const

export const TerminalBinaryMessageType = {
  InputUtf8: 1,
  OutputUtf8: 2,
  Ack: 3,
} as const

export const TerminalBinaryFlags = {
  Replay: 1,
} as const
...
export function encodeBinaryMuxFrame(frame: BinaryMuxFrame): Uint8Array<ArrayBuffer> {
